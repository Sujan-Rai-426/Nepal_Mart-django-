...
# Manually created file for forms 

# Need to create form for those which need to save data to database
...
class Register_User_Form(UserCreationForm):
    email = forms.EmailField(label ='', max_length=50, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'example@gmail.com'}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        # These code help to decorate form
